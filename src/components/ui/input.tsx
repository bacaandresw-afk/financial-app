...
const fieldClasses =
  "w-full rounded-2xl border border-border bg-card px-3.5 h-11 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary disabled:opacity-50 disabled:cursor-not-allowed";
