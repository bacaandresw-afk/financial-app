  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-expanded={open}
        className={cn(
          "h-16 w-16 rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/30 flex items-center justify-center active:scale-95 transition-transform",
        )}
      >
